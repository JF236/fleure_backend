...
export class ListBundlesByCategory extends OpenAPIRoute {
	constructor() {
		super(null);
	}
	...
	static schema: OpenAPIRouteSchema = {
		tags: ["Bundle"],
		summary: "List bundles belonging to a specified category",
	...
	async handle(
		...
		try {
			const result = await env.DB.prepare(`SELECT * FROM bundles WHERE category_id = ?`)
			  .bind(category_id)
			  .all();
